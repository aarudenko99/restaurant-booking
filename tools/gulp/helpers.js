            ...
            outputs.forEach(function (output) {
                if (output.indexOf('/**/') !== -1) {
                    module.exports.getDemos().forEach(function (demo) {
                        ...
                        if (outputPath.indexOf('/assets/mijn-menu-dashboard/') !== -1 && outputPath.indexOf('/assets/mijn-menu-dashboard/' + demo) === -1) {
                        ...
                        case 'styles-by-demo':
                            ...
                            module.exports.getDemos().forEach(function (demo) {
                                ...
                                stream = gulp.src(bundle.src[type], {allowEmpty: true}).pipe(_self.cssChannel(false, [
                                    '../themes/themes/' + module.exports.config.theme + '/src/sass/theme/' + demo + '/', //  development
                                    '../src/assets/sass/theme/' + demo + '/', // release default package
                                    '../src/sass/theme/' + demo + '/', // release angular package
