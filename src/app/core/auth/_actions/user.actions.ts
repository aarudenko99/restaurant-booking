...
export enum UserActionTypes {
    ...
    UserUpdatedSuccess = '[Edit User Dialog] User Updated Success',
...
export class UserUpdatedSuccess implements Action {
    readonly type = UserActionTypes.UserUpdatedSuccess;
    constructor(public payload: any) {}
}

export class UserDeleted implements Action {
    readonly type = UserActionTypes.UserDeleted;
    constructor(public payload: { id: number, _id: string }) {}
}
