export class PageConfig {
    public defaults: any = {
        template: {
            ...
            'my-restaurants': {
                page: { title: 'My Restaurants', desc: ''}
            },
            'create-restaurant': {
                page: { title: 'Create new restaurant', desc: ''}
            },
            'user-management': {
                users: {
            ...
            tablemanagement: {
                page: { title: 'Table Management', desc: ''}
            },
            reservations: {
                page: { title: 'Reservations', desc: ''}
            },
            liveorders: {
                page: { title: 'Live Orders', desc: ''}
            },
            menu: {
              page: { title: 'Menu', desc: 'Create your own menu' }
            },
            ngbootstrap: {
                accordion: {
